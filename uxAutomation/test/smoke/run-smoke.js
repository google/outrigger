...
//
// Source: https://github.com/googleads/publisher-ads-lighthouse-plugin/blob/master/lighthouse-plugin-publisher-ads/test/smoke/run-smoke.js
//
'use strict';
...
const SMOKEHOUSE_TMP_DIR = `${CLI_ROOT}/test/smokehouse/.tmp`;
...
function init() {
  const cmd = [
    ...
    `ln -sf . lighthouse-plugin-autoux`,
